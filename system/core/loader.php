...
function sys_load_helpers($helpers){
	foreach($helpers as $helper){
		if(is_file($file = SYSPATH."/helpers/$helper.php")){
			require $file;
		}else if(is_file($file = $file = APPPATH."/helpers/$helper.php")){
			require $file;
		}else{
...
function sys_load_library($libraries){
	foreach($libraries as $library){
		if(is_file($file = SYSPATH."/libraries/$library.php")){
			require $file;
		}else if(is_file($file = $file = APPPATH."/libraries/$library.php")){
			require $file;
		}else{
